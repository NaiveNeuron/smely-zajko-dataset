...
print('\n')
model = models.mlp(n_input=75, architecture=[(80, 'relu'), (2, 'softmax')],
...
model.save('mlp_cat_80_relu_2_softmax.h5')
print('\n')
model = models.mlp(n_input=75, architecture=[(120, 'relu'), (2, 'softmax')],
                   metrics=['accuracy'], loss=loss)
train_and_eval(model, X_train, y_train, X_test, y_test,
               score_name='accuracy', score_format='{[1]}', verbose=verbose,
               batch_size=batch_size, nb_epoch=nb_epoch)

model.save('mlp_cat_120_relu_2_softmax.h5')
print('\n')
model = models.mlp(n_input=75, architecture=[(200, 'relu'), (2, 'softmax')],
                   metrics=['accuracy'], loss=loss)
train_and_eval(model, X_train, y_train, X_test, y_test,
               score_name='accuracy', score_format='{[1]}', verbose=verbose,
               batch_size=batch_size, nb_epoch=nb_epoch)

model.save('mlp_cat_200_relu_2_softmax.h5')
print('\n')
model = models.mlp(n_input=75, architecture=[(60, 'relu'),
                                             (60, 'relu'),
                                             (2, 'softmax')],
                   metrics=['accuracy'], loss=loss)
train_and_eval(model, X_train, y_train, X_test, y_test,
...
model.save('mlp_cat_60_relu_60_relu_2_softmax.h5')
print('\n')
model = models.mlp(n_input=75, architecture=[(100, 'relu'),
                                             (100, 'relu'),
                                             (2, 'softmax')],
                   metrics=['accuracy'], loss=loss)
train_and_eval(model, X_train, y_train, X_test, y_test,
               score_name='accuracy', score_format='{[1]}', verbose=verbose,
               batch_size=batch_size, nb_epoch=nb_epoch)
model.save('mlp_cat_100_relu_100_relu_2_softmax.h5')
